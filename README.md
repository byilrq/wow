...
- 魔兽世界 WLK 图片标志已移动到网页抬头中央。
- 首页首屏左侧为补充后的服务器信息，右侧为账号注册。
- 公告页发布区域左侧同步显示服务器信息，和注册区域采用同一行布局风格。


## 本次界面修正

- 魔兽世界图片标志缩小为网页抬头中央的小标志，不再占据页面主体。
- 删除服务器信息中的“使用本站账号登录客户端；如需通过本 VPS 中转游戏流量……”提示语。
